  ...
  return (
    <div className="d-flex pding justify-content-between">
      <div className="d-flex">
        <div className="divIniciar">
          <button className="submitButton" id="buttonIniciar" onClick={verForm}>
            Iniciar Sesion
          </button>
          <div className="divForm">
            ...
            >
              ...
              <button id="button" className=" submitButton mt-4">
                Login
              </button>
              <a class="mt-3" href="#">
      ...
      <div>
        <button className="p-3">Day/Light</button>
      </div>
    </div>
  );
};
